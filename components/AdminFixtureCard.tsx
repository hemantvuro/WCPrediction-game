...
interface AdminFixtureCardProps {
  fixture: Fixture;
  onEdit: (fixture: Fixture) => void;
  onDelete: (id: string) => void;
}

export default function AdminFixtureCard({ fixture, onEdit, onDelete }: AdminFixtureCardProps) {
      ...
      <div className="p-6">
        ...
        <div className="flex gap-2 mt-4 pt-4 border-t border-gray-200">
          <button
            ...
            className="flex-1 px-4 py-2 bg-blue-400 text-white rounded-lg hover:bg-blue-500 transition font-semibold shadow-sm"
          >
            ✏️ Edit
          </button>
          <button
            onClick={() => onDelete(fixture.id)}
            className="flex-1 px-4 py-2 bg-red-100 text-red-700 border-2 border-red-300 rounded-lg hover:bg-red-200 transition font-semibold shadow-sm"
          >
            🗑️ Delete
          </button>
        </div>
